...
const {uploadProduct, paymentProof, deleteJob, editProduct} = require('../controller/product.controller'); // Adjust the path according to your project structure
...
router.post('/editjob/:productId', editProduct);
